...
public final class ApplicationConstants {
  ...
  public static final class Messages {
    ...
    public static final String INSTITUTE_INFO_RETRIEVED_SUCCESS =
        "Institute information retrieved successfully";
    ...
    public static final String INSUFFICIENT_PERMISSIONS =
        "Insufficient permissions to create this user type";
    public static final String ACCESS_DENIED = "Access denied";
    public static final String ACCESS_DENIED_INSTITUTE =
        "Access denied - user not in your institute";
    public static final String ACCESS_DENIED_STUDENT_ONLY =
        "Access denied - only students can access this endpoint";
